...
class NaverBookScraper:
    ...
    NAVER_API_CLIENT_ID = config("NAVER_API_CLIENT_ID")
    NAVER_API_CLIENT_SECRET = config("NAVER_API_CLIENT_SECRET")
    ...
    def unit_url(self, keyword, start):
        return {
            ...
            "headers": {
                "X-Naver-Client-Id": self.NAVER_API_CLIENT_ID,
                "X-Naver-Client-Secret": self.NAVER_API_CLIENT_SECRET,
            }
        }
